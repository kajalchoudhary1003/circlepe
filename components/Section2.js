  ...
  return (
    ...
    >
      <div className="main relative h-screen flex flex-row">
          ...
          <div className="partition h-screen flex flex-row space-x-5">
            ...
            >
              ...
              <div className="para text-secondary text-2xl 2xl:text-[60px]">
                <ul className="customList">
                  <li className="text-[#fcf1b6] mb-5 2xl:mb-16">
                    Tenant selects the property
                  </li>
                  <li className="text-primary -mb-2 2xl:mb-5">
                    Tenant selects flexible rent tenure &{" "}
                  </li>
                  <span className="text-primary ml-7 2xl:ml-12">
            ...
            <div className="image flex items-end flex-grow">
              <Image
                ...
                width={390}
                height={690}
                className="rounded-tl-[64px] xl:w-[550px] xl:rounded-tl-[92px] xl:rounded-tr-[92px] xl:h-[900px] rounded-tr-[64px] 2xl:w-[1000px] 2xl:h-[1700px] 2xl:rounded-tl-[170px] 2xl:rounded-tr-[170px]"
              />
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-1/2 left-1/4 transform xl:-translate-x-24 xl:-translate-y-48 2xl:translate-y-15 2xl:translate-x-1 -translate-y-44 -translate-x-1 z-10">
          <Image
            src="/images/d2.svg"
            width={400}
            height={400}
