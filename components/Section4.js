...
function Section4({currentSection}) {
  ...
  >
   <div className="main relative h-screen flex flex-row">
          ...
          <div className="partition h-screen flex flex-row space-x-10">
              ...
              <div className="para text-secondary text-2xl">
                ...
                <span>
                  <ul className="customList4">
                    <li className="-mb-2">Zero Security deposit move-in</li>
                    <li className="-mb-2">Reduced rent offer</li>
            ...
            <div className="image flex items-start flex-grow">
              <Image
                ...
                width={400}
                height={690}
                className="rounded-bl-[66px] rounded-br-[66px]"
              />
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-1/2 left-1/4 transform -translate-y-20 translate-x-16 z-10">
          <Image
            src="/images/d4.svg"
            width={350}
            height={350}
